 ...
 * heycoding@gmail.com
 */
object UpcomingMapper: ViewParamMapper<MovieResponse, UpcomingViewParam> {
    override fun toViewParam(dataObject: MovieResponse?): UpcomingViewParam = UpcomingViewParam(
