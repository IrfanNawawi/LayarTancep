...
import id.heycoding.layartancep.data.remote.response.credit.Cast
import id.heycoding.layartancep.data.remote.response.detail.DetailMovieResponse
import id.heycoding.layartancep.data.remote.response.genre.Genre
...
import id.heycoding.layartancep.utils.orFalse
import id.heycoding.layartancep.utils.orNol
...
fun List<id.heycoding.layartancep.data.remote.response.movie.Result>?.mappingPopularMovieToUseCaseEntity(): List<Movies> {
...
fun List<id.heycoding.layartancep.data.remote.response.movie.Result>?.mappingUpcomingMovieToUseCaseEntity(): List<Movies> {
    val newList: MutableList<Movies> = mutableListOf()
...
fun List<id.heycoding.layartancep.data.remote.response.movie.Result>?.mappingGenreMovieToUseCaseEntity(): List<Movies> {
    val newList: MutableList<Movies> = mutableListOf()
...
fun List<id.heycoding.layartancep.data.remote.response.movie.Result>?.mappingSearchMovieToUseCaseEntity(): List<Movies> {
    val newList: MutableList<Movies> = mutableListOf()
...
fun List<id.heycoding.layartancep.data.remote.response.review.Result>?.mappingReviewToUseCaseEntity(): List<Reviews> {
...
fun List<id.heycoding.layartancep.data.remote.response.trailer.Result>?.mappingTrailerToUseCaseEntity(): List<Trailers> {
