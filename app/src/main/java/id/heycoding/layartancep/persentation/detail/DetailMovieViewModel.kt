...
import id.heycoding.layartancep.domain.usecase.credit.CreditUseCase
import id.heycoding.layartancep.domain.usecase.detail.DetailMovieUseCase
import id.heycoding.layartancep.domain.usecase.review.ReviewUseCase
import id.heycoding.layartancep.domain.usecase.trailer.TrailerUseCase
import id.heycoding.layartancep.persentation.detail.credit.CreditMovieState
import id.heycoding.layartancep.persentation.detail.review.ReviewMovieState
import id.heycoding.layartancep.persentation.detail.trailer.TrailerMovieState
